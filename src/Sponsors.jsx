  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      ...
      cardRefs.current.forEach((card, index) => {
        ...
        const rotateY = (-(rect.width / 2 - x) / 15); // Adjusted for smaller cards
        const rotateX = ((rect.height / 2 - y) / 10); // Adjusted for smaller cards
            ...
            >
              <div className="card-content">
                <img
                  ...
                  onError={(e) => {
                    console.error(`Failed to load image for ${sponsor.alt}`);
